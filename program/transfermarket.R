...
transfermarket <- function(temporadas_vec=0,jogos_vec=0,sobrescreve=T){
                    ...
                    # Micro info jogos ----
                      ...
                      for(i in jogos_vec){
                        ...
                        all_saved <- rbind(all_saved,data.table(base_jogo_temp_saved))
                      ...
                      name_file <- paste0("S_saved_",temporada,".rds")
                      saveRDS(all_saved,
                              file.path(pathout,
                                        name_file))
...
transfermarket(temporadas_vec = 2016,jogos_vec = 0 , sobrescreve = F)
